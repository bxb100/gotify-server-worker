...
export const PushMessageDialog = ({ appName, defaultPriority, fClose, fOnSubmit }: IProps) => {
	...
	return (
		<Dialog open={true} onClose={fClose} aria-labelledby="push-message-title" id="push-message-dialog">
			<DialogTitle id="push-message-title">Push message</DialogTitle>
			<DialogContent>
				<DialogContentText>
					Send a push message via {appName}. Leave the title empty to use the application name.
				</DialogContentText>
				<TextField
					margin="dense"
					className="title"
