...
import { Button, IconButton, Typography, ListItemText, ListItemAvatar, Avatar, ListItemButton } from "@mui/material";
...
const Navigation = observer(({ loggedIn, navOpen, setNavOpen }: IProps) => {
	const [showRequestNotification, setShowRequestNotification] = React.useState(mayAllowPermission);
...
const ResponsiveDrawer: React.FC<DrawerProps & { navOpen: boolean; setNavOpen: (open: boolean) => void }> = ({
	navOpen,
	setNavOpen,
	children,
	...rest
	...
	<>
		<Drawer sx={{ display: { sm: "none", xs: "block" } }} variant="temporary" open={navOpen} {...rest}>
