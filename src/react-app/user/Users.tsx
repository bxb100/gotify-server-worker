...
const Users = observer(() => {
  ...
  return (
    <DefaultPage
      title="Users"
      rightControl={
        <Button id="create-user" variant="contained" color="primary" onClick={() => setCreateDialog(true)}>
          Create User
        </Button>
      }
    >
      ...
      {createDialog && <AddEditDialog fClose={() => setCreateDialog(false)} fOnSubmit={userStore.create} />}
      {editUser && (
        <AddEditDialog
