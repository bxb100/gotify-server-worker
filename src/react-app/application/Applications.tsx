...
const Applications = observer(() => {
  ...
  return (
    <DefaultPage
      title="Applications"
      rightControl={
        <Button id="create-app" variant="contained" color="primary" onClick={() => setCreateDialog(true)}>
          Create Application
        </Button>
      }
      maxWidth={1000}
    >
      ...
      {createDialog && <AddApplicationDialog fClose={() => setCreateDialog(false)} fOnSubmit={appStore.create} />}
      {toUpdateApp != null && (
      ...
      <TableCell padding="normal">
        <div style={{ display: "flex" }}>
          <Tooltip title="Delete image" placement="top" arrow>
            <ButtonBase className={classes.imageContainer} onClick={fDeleteImage} disabled={isDefaultImage}>
              <img src={config.get("url") + app.image} alt="app logo" width="40" height="40" />
            </ButtonBase>
          </Tooltip>
